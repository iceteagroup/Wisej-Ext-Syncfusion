namespace Wisej.Web.Ext.Syncfusion.Test.Component
{
	partial class ejRating
	{
		...
		private void InitializeComponent()
		{
			...
			this.label7.Text = "A young boy learns that he has extraordinary powers and is not of this Earth.";
			// 
			// label6
			// 
			...
			this.ejRating1.TabIndex = 11;
			this.ejRating1.Text = "ejRating1";
			// 
			// tabPage2
			// 
    ...
    "urban gridlock, he senses that it\'s no ordinary traffic jam";
			...
			this.label12.Text = "Ever since he was a kid monster, Mike Wazowski (Billy Crystal) has dreamed of bec" +
    "oming a Scarer. To make his dream a reality, he enrolls at Monsters University.";
			// 
			// label13
			// 
			...
			this.label15.Text = "Monsters University";
			// 
			// ejRating3
			// 
		...
		private Syncfusion.ejRating ejRating1;
		...
		private Syncfusion.ejRating ejRating2;
