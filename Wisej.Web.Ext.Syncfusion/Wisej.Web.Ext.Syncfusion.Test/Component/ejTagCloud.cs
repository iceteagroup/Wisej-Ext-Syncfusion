...
{
	public partial class ejTagCloud : Wisej.Web.Ext.Syncfusion.Test.Component.TestBase
	{
		public ejTagCloud()
		{
			InitializeComponent();

			this.ejTagCloud1.Widget.click += new WidgetEventHandler(ejTagCloud1_WidgetEvent);
		}
