namespace Wisej.Web.Ext.Syncfusion.Test.Component
{
	partial class ejCheckBox
	{
		...
		private void InitializeComponent()
		{
			...
			this.ejCheckBox6 = new Wisej.Web.Ext.Syncfusion.ejCheckBox();
			this.label4 = new Wisej.Web.Label();
			this.ejCheckBox1 = new Wisej.Web.Ext.Syncfusion.ejCheckBox();
			this.ejCheckBox2 = new Wisej.Web.Ext.Syncfusion.ejCheckBox();
			this.panel2 = new Wisej.Web.Panel();
			this.ejCheckBox3 = new Wisej.Web.Ext.Syncfusion.ejCheckBox();
			this.label5 = new Wisej.Web.Label();
			this.ejCheckBox4 = new Wisej.Web.Ext.Syncfusion.ejCheckBox();
			this.ejCheckBox5 = new Wisej.Web.Ext.Syncfusion.ejCheckBox();
			this.panel3 = new Wisej.Web.Panel();
			this.ejCheckBox7 = new Wisej.Web.Ext.Syncfusion.ejCheckBox();
			...
			this.panel1.Controls.Add(this.ejCheckBox6);
			...
			this.panel2.Controls.Add(this.ejCheckBox3);
			...
			this.panel2.Location = new System.Drawing.Point(51, 122);
			...
			this.panel3.Controls.Add(this.ejCheckBox7);
			...
			this.panel3.Location = new System.Drawing.Point(51, 233);
		...
		private Syncfusion.ejCheckBox ejCheckBox1;
		private Panel panel1;
		private Label label4;
		private Syncfusion.ejCheckBox ejCheckBox2;
		private Syncfusion.ejCheckBox ejCheckBox6;
		private Panel panel2;
		private Syncfusion.ejCheckBox ejCheckBox3;
		private Label label5;
		private Syncfusion.ejCheckBox ejCheckBox4;
		private Syncfusion.ejCheckBox ejCheckBox5;
		private Panel panel3;
		private Syncfusion.ejCheckBox ejCheckBox7;
